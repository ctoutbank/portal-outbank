...
import { customers, merchantPriceGroup, merchantTransactionPrice, settlements, paymentInstitution, paymentLink, shoppingItems, reports, reportFilters, reportFiltersParam, solicitationFee, solicitationFeeBrand, merchants, merchantfile, file, userMerchants, users, solicitationFeeDocument, fee, feeBrand, profiles, profileFunctions, functions, payoutAntecipations, userNotifications, salesAgents, modules, moduleFunctions, categories, legalNatures, configurations, addresses, merchantPrice, merchantBankAccounts, solicitationBrandProductType, financialAdjustments, financialAdjustmentMerchants, feeBrandProductType, merchantpixaccount, feeCredit, customerFunctions, payout, contacts, customerCustomization, reportExecution, reportExecutionStatus, merchantSettlements, merchantSettlementOrders, merchantPixSettlementOrders } from "./schema";
