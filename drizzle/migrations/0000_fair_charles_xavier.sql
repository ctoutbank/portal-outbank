...
CREATE TABLE "addresses" (
	"id" bigint PRIMARY KEY GENERATED ALWAYS AS IDENTITY (sequence name "addresses_id_seq" INCREMENT BY 1 MINVALUE 1 MAXVALUE 9223372036854776000 START WITH 1 CACHE 1),
...
--> statement-breakpoint
CREATE TABLE "bank" (
	"id" bigint PRIMARY KEY GENERATED ALWAYS AS IDENTITY (sequence name "bank_id_seq" INCREMENT BY 1 MINVALUE 1 MAXVALUE 9223372036854776000 START WITH 1 CACHE 1),
	"active" boolean,
	"dtinsert" timestamp,
	"dtupdate" timestamp,
	"name" varchar(255),
...
CREATE TABLE "categories" (
	"id" bigint PRIMARY KEY GENERATED ALWAYS AS IDENTITY (sequence name "categories_id_seq" INCREMENT BY 1 MINVALUE 1 MAXVALUE 9223372036854776000 START WITH 1 CACHE 1),
	"slug" varchar(50),
	"active" boolean,
	"dtinsert" timestamp,
	"dtupdate" timestamp,
...
CREATE TABLE "cnaes" (
	...
	CONSTRAINT "cnaes_codigo_unique" UNIQUE("codigo"),
	CONSTRAINT "cnaes_codigo_key" UNIQUE("codigo")
);
--> statement-breakpoint
CREATE TABLE "configurations" (
	"id" bigint PRIMARY KEY GENERATED ALWAYS AS IDENTITY (sequence name "configurations_id_seq" INCREMENT BY 1 MINVALUE 1 MAXVALUE 9223372036854776000 START WITH 1 CACHE 1),
	"slug" varchar(50),
	"active" boolean,
	"dtinsert" timestamp,
	"dtupdate" timestamp,
...
CREATE TABLE "contacts" (
	"id" bigint PRIMARY KEY GENERATED ALWAYS AS IDENTITY (sequence name "contacts_id_seq" INCREMENT BY 1 MINVALUE 1 MAXVALUE 9223372036854776000 START WITH 1 CACHE 1),
	"name" varchar(255),
...
--> statement-breakpoint
CREATE TABLE "customer_customization" (
	"slug" text NOT NULL,
	"name" varchar(100) NOT NULL,
	...
	"login_image_url" varchar(100),
	"favicon_url" varchar(100),
	"customer_id" bigint,
	"id" bigint GENERATED ALWAYS AS IDENTITY (sequence name "tenants_id_seq" INCREMENT BY 1 MINVALUE 1 MAXVALUE 9223372036854776000 START WITH 1 CACHE 1),
	"file_id" bigint,
	"login_image_file_id" bigint,
	"favicon_file_id" bigint,
	CONSTRAINT "tenants_slug_key" UNIQUE("slug")
);
--> statement-breakpoint
CREATE TABLE "customer_functions" (
	"id" bigint PRIMARY KEY GENERATED ALWAYS AS IDENTITY (sequence name "customer_functions_id_seq" INCREMENT BY 1 MINVALUE 1 MAXVALUE 9223372036854776000 START WITH 1 CACHE 1),
	"slug" varchar(50),
...
CREATE TABLE "customers" (
	...
	"id" bigint PRIMARY KEY GENERATED ALWAYS AS IDENTITY (sequence name "customers_id_seq" INCREMENT BY 1 MINVALUE 1 MAXVALUE 9223372036854776000 START WITH 1 CACHE 1),
	"id_parent" bigint,
...
--> statement-breakpoint
CREATE TABLE "fee" (
	"id" bigint PRIMARY KEY GENERATED ALWAYS AS IDENTITY (sequence name "fee_id_seq" INCREMENT BY 1 MINVALUE 1 MAXVALUE 9223372036854776000 START WITH 1 CACHE 1),
	"slug" varchar(50),
	"active" boolean,
	"dtinsert" timestamp DEFAULT CURRENT_TIMESTAMP,
...
--> statement-breakpoint
CREATE TABLE "fee_brand" (
	"id" bigint PRIMARY KEY GENERATED ALWAYS AS IDENTITY (sequence name "fee_brand_id_seq" INCREMENT BY 1 MINVALUE 1 MAXVALUE 9223372036854776000 START WITH 1 CACHE 1),
	"slug" varchar(50),
	"active" boolean,
	"dtinsert" timestamp DEFAULT CURRENT_TIMESTAMP,
	"dtupdate" timestamp DEFAULT CURRENT_TIMESTAMP,
...
--> statement-breakpoint
CREATE TABLE "fee_brand_product_type" (
	"id" bigint PRIMARY KEY GENERATED ALWAYS AS IDENTITY (sequence name "fee_brand_product_type_id_seq" INCREMENT BY 1 MINVALUE 1 MAXVALUE 9223372036854776000 START WITH 1 CACHE 1),
	"slug" varchar(50),
	"active" boolean,
	"dtinsert" timestamp DEFAULT CURRENT_TIMESTAMP,
	"dtupdate" timestamp DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE "fee_credit" (
	"id" bigint PRIMARY KEY GENERATED ALWAYS AS IDENTITY (sequence name "fee_credit_id_seq" INCREMENT BY 1 MINVALUE 1 MAXVALUE 9223372036854776000 START WITH 1 CACHE 1),
...
--> statement-breakpoint
CREATE TABLE "file" (
	"id" bigint PRIMARY KEY GENERATED ALWAYS AS IDENTITY (sequence name "file_id_seq" INCREMENT BY 1 MINVALUE 1 MAXVALUE 9223372036854776000 START WITH 1 CACHE 1),
...
--> statement-breakpoint
CREATE TABLE "financial_adjustment_merchants" (
	"id" bigint PRIMARY KEY GENERATED ALWAYS AS IDENTITY (sequence name "financial_adjustment_merchants_id_seq" INCREMENT BY 1 MINVALUE 1 MAXVALUE 9223372036854776000 START WITH 1 CACHE 1),
	"slug" varchar(50),
	"dtinsert" timestamp DEFAULT CURRENT_TIMESTAMP,
	"dtupdate" timestamp DEFAULT CURRENT_TIMESTAMP,
	"active" boolean,
...
CREATE TABLE "financial_adjustments" (
	"id" bigint PRIMARY KEY GENERATED ALWAYS AS IDENTITY (sequence name "financial_adjustments_id_seq" INCREMENT BY 1 MINVALUE 1 MAXVALUE 9223372036854776000 START WITH 1 CACHE 1),
	"external_id" integer,
	"slug" varchar(50),
	"dtinsert" timestamp DEFAULT CURRENT_TIMESTAMP,
	"dtupdate" timestamp DEFAULT CURRENT_TIMESTAMP,
...
--> statement-breakpoint
CREATE TABLE "fornecedor_documents" (
	"id" uuid PRIMARY KEY DEFAULT gen_random_uuid() NOT NULL,
...
CREATE TABLE "functions" (
	"id" bigint PRIMARY KEY GENERATED ALWAYS AS IDENTITY (sequence name "functions_id_seq" INCREMENT BY 1 MINVALUE 1 MAXVALUE 9223372036854776000 START WITH 1 CACHE 1),
	"slug" varchar(50),
	"dtinsert" timestamp DEFAULT CURRENT_TIMESTAMP,
	"dtupdate" timestamp,
	"active" boolean DEFAULT true,
...
CREATE TABLE "legal_natures" (
	"id" bigint PRIMARY KEY GENERATED ALWAYS AS IDENTITY (sequence name "legal_natures_id_seq" INCREMENT BY 1 MINVALUE 1 MAXVALUE 9223372036854776000 START WITH 1 CACHE 1),
	"slug" varchar(50),
	"active" boolean,
	"dtinsert" timestamp,
	"dtupdate" timestamp,
...
CREATE TABLE "merchant_bank_accounts" (
	"id" bigint PRIMARY KEY GENERATED ALWAYS AS IDENTITY (sequence name "merchant_bank_accounts_id_seq" INCREMENT BY 1 MINVALUE 1 MAXVALUE 9223372036854776000 START WITH 1 CACHE 1),
...
CREATE TABLE "merchant_pix_settlement_orders" (
	"id" bigint PRIMARY KEY GENERATED ALWAYS AS IDENTITY (sequence name "merchant_pix_settlement_orders_id_seq" INCREMENT BY 1 MINVALUE 1 MAXVALUE 9223372036854776000 START WITH 1 CACHE 1),
	"slug" varchar(50),
	"active" boolean,
	"dtinsert" timestamp,
	"dtupdate" timestamp,
...
CREATE TABLE "merchant_price" (
	"id" bigint PRIMARY KEY GENERATED ALWAYS AS IDENTITY (sequence name "merchant_price_id_seq" INCREMENT BY 1 MINVALUE 1 MAXVALUE 9223372036854776000 START WITH 1 CACHE 1),
	"slug" varchar(50),
	"active" boolean,
	"dtinsert" timestamp,
	"dtupdate" timestamp,
...
CREATE TABLE "merchant_price_group" (
	"id" bigint PRIMARY KEY GENERATED ALWAYS AS IDENTITY (sequence name "merchant_price_group_id_seq" INCREMENT BY 1 MINVALUE 1 MAXVALUE 9223372036854776000 START WITH 1 CACHE 1),
	"slug" varchar(50),
	"active" boolean,
	"dtinsert" timestamp,
	"dtupdate" timestamp,
...
CREATE TABLE "merchant_settlement_orders" (
	"id" bigint PRIMARY KEY GENERATED ALWAYS AS IDENTITY (sequence name "merchant_settlement_orders_id_seq" INCREMENT BY 1 MINVALUE 1 MAXVALUE 9223372036854776000 START WITH 1 CACHE 1),
	"slug" varchar(50),
	"active" boolean,
	"dtinsert" timestamp,
	"dtupdate" timestamp,
...
CREATE TABLE "merchant_settlements" (
	"id" bigint PRIMARY KEY GENERATED ALWAYS AS IDENTITY (sequence name "merchantsettlements_id_seq" INCREMENT BY 1 MINVALUE 1 MAXVALUE 9223372036854776000 START WITH 1 CACHE 1),
	"slug" varchar(50),
	"active" boolean,
	"dtinsert" timestamp,
	"dtupdate" timestamp,
...
CREATE TABLE "merchant_transaction_price" (
	"id" bigint PRIMARY KEY GENERATED ALWAYS AS IDENTITY (sequence name "merchant_transaction_price_id_seq" INCREMENT BY 1 MINVALUE 1 MAXVALUE 9223372036854776000 START WITH 1 CACHE 1),
	"slug" varchar(50),
	"active" boolean,
	"dtinsert" timestamp,
	"dtupdate" timestamp,
...
CREATE TABLE "merchantfile" (
	"id" bigint PRIMARY KEY GENERATED ALWAYS AS IDENTITY (sequence name "fl_merchantfile_id_seq" INCREMENT BY 1 MINVALUE 1 MAXVALUE 9223372036854776000 START WITH 1 CACHE 1),
	"id_merchant" bigint,
	"id_file" bigint,
	"active" boolean DEFAULT true,
	"dtinsert" timestamp DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE "merchantpixaccount" (
	"id" bigint PRIMARY KEY GENERATED ALWAYS AS IDENTITY (sequence name "merchantpixaccount_id_seq" INCREMENT BY 1 MINVALUE 1 MAXVALUE 9223372036854776000 START WITH 1 CACHE 1),
	"slug" varchar(50),
	"active" boolean,
	"dtinsert" timestamp,
	"dtupdate" timestamp,
...
CREATE TABLE "merchants" (
	"id" bigint PRIMARY KEY GENERATED ALWAYS AS IDENTITY (sequence name "merchants_id_seq" INCREMENT BY 1 MINVALUE 1 MAXVALUE 9223372036854776000 START WITH 1 CACHE 1),
	"slug" varchar(50),
	"active" boolean,
	"dtinsert" timestamp,
	"dtupdate" timestamp,
...
CREATE TABLE "module_functions" (
	"id" bigint PRIMARY KEY GENERATED ALWAYS AS IDENTITY (sequence name "module_functions_id_seq" INCREMENT BY 1 MINVALUE 1 MAXVALUE 9223372036854776000 START WITH 1 CACHE 1),
	"slug" varchar(50),
	"dtinsert" timestamp DEFAULT CURRENT_TIMESTAMP,
	"dtupdate" timestamp,
	"active" boolean DEFAULT true,
...
CREATE TABLE "modules" (
	"id" bigint PRIMARY KEY GENERATED ALWAYS AS IDENTITY (sequence name "modules_id_seq" INCREMENT BY 1 MINVALUE 1 MAXVALUE 9223372036854776000 START WITH 1 CACHE 1),
	"slug" varchar(50),
	"dtinsert" timestamp DEFAULT CURRENT_TIMESTAMP,
	"dtupdate" timestamp,
	"active" boolean DEFAULT true,
...
CREATE TABLE "payment_institution" (
	"id" bigint PRIMARY KEY GENERATED ALWAYS AS IDENTITY (sequence name "payment_institution_id_seq" INCREMENT BY 1 MINVALUE 1 MAXVALUE 9223372036854776000 START WITH 1 CACHE 1),
	"slug" varchar(50),
	"name" varchar(255),
...
CREATE TABLE "payment_link" (
	"id" bigint PRIMARY KEY GENERATED ALWAYS AS IDENTITY (sequence name "payment_link_id_seq" INCREMENT BY 1 MINVALUE 1 MAXVALUE 9223372036854776000 START WITH 1 CACHE 1),
	"slug" varchar(50),
	"active" boolean,
	"dtinsert" timestamp,
	"dtupdate" timestamp,
...
--> statement-breakpoint
CREATE TABLE "payout" (
	"id" bigint PRIMARY KEY GENERATED ALWAYS AS IDENTITY (sequence name "payout_id_seq" INCREMENT BY 1 MINVALUE 1 MAXVALUE 9223372036854776000 START WITH 1 CACHE 1),
	"slug" varchar(50),
...
CREATE TABLE "payout_antecipations" (
	"id" bigint PRIMARY KEY GENERATED ALWAYS AS IDENTITY (sequence name "payout_antecipations_id_seq" INCREMENT BY 1 MINVALUE 1 MAXVALUE 9223372036854776000 START WITH 1 CACHE 1),
	"slug" varchar(50),
	"payout_id" varchar(50),
	"slug_merchant" varchar(50),
	"id_merchants" bigint,
...
CREATE TABLE "profile_functions" (
	"id" bigint PRIMARY KEY GENERATED ALWAYS AS IDENTITY (sequence name "profile_functions_id_seq" INCREMENT BY 1 MINVALUE 1 MAXVALUE 9223372036854776000 START WITH 1 CACHE 1),
	"slug" varchar(50),
	"dtinsert" timestamp DEFAULT CURRENT_TIMESTAMP,
	"dtupdate" timestamp,
	"active" boolean DEFAULT true,
...
CREATE TABLE "profiles" (
	"id" bigint PRIMARY KEY GENERATED ALWAYS AS IDENTITY (sequence name "profiles_id_seq" INCREMENT BY 1 MINVALUE 1 MAXVALUE 9223372036854776000 START WITH 1 CACHE 1),
	"slug" varchar(50),
	"dtinsert" timestamp DEFAULT CURRENT_TIMESTAMP,
	"dtupdate" timestamp,
	"active" boolean DEFAULT true,
...
CREATE TABLE "report_filters" (
	"id" bigint PRIMARY KEY GENERATED ALWAYS AS IDENTITY (sequence name "report_filters_id_seq" INCREMENT BY 1 MINVALUE 1 MAXVALUE 9223372036854776000 START WITH 1 CACHE 1),
...
CREATE TABLE "report_filters_param" (
	"id" bigint PRIMARY KEY GENERATED ALWAYS AS IDENTITY (sequence name "report_filters_param_id_seq" INCREMENT BY 1 MINVALUE 1 MAXVALUE 9223372036854776000 START WITH 1 CACHE 1),
...
CREATE TABLE "reports" (
	"id" bigint PRIMARY KEY GENERATED ALWAYS AS IDENTITY (sequence name "reports_id_seq" INCREMENT BY 1 MINVALUE 1 MAXVALUE 9223372036854776000 START WITH 1 CACHE 1),
...
CREATE TABLE "sales_agents" (
	"id" bigint PRIMARY KEY GENERATED ALWAYS AS IDENTITY (sequence name "sales_agents_id_seq" INCREMENT BY 1 MINVALUE 1 MAXVALUE 9223372036854776000 START WITH 1 CACHE 1),
	"slug" varchar(50),
	"active" boolean,
	"dtinsert" timestamp,
	"dtupdate" timestamp,
...
CREATE TABLE "settlements" (
	"id" bigint PRIMARY KEY GENERATED ALWAYS AS IDENTITY (sequence name "settlements_id_seq" INCREMENT BY 1 MINVALUE 1 MAXVALUE 9223372036854776000 START WITH 1 CACHE 1),
	"slug" varchar(50),
	"active" boolean,
	"dtinsert" timestamp,
	"dtupdate" timestamp,
...
CREATE TABLE "shopping_items" (
	"id" bigint PRIMARY KEY GENERATED ALWAYS AS IDENTITY (sequence name "shopping_items_id_seq" INCREMENT BY 1 MINVALUE 1 MAXVALUE 9223372036854776000 START WITH 1 CACHE 1),
	"dtinsert" timestamp DEFAULT CURRENT_TIMESTAMP,
	"dtupdate" timestamp DEFAULT CURRENT_TIMESTAMP,
	"active" boolean DEFAULT true,
...
--> statement-breakpoint
CREATE TABLE "solicitation_brand_product_type" (
	"id" bigint PRIMARY KEY GENERATED ALWAYS AS IDENTITY (sequence name "solicitation_brand_product_type_id_seq" INCREMENT BY 1 MINVALUE 1 MAXVALUE 9223372036854776000 START WITH 1 CACHE 1),
	"slug" varchar(50),
...
--> statement-breakpoint
CREATE TABLE "solicitation_fee" (
	"id" bigint PRIMARY KEY GENERATED ALWAYS AS IDENTITY (sequence name "solicitation_fee_id_seq" INCREMENT BY 1 MINVALUE 1 MAXVALUE 9223372036854776000 START WITH 1 CACHE 1),
	"slug" varchar(50),
	"cnae" varchar(20),
	"id_customers" bigint,
	"mcc" varchar(20),
...
--> statement-breakpoint
CREATE TABLE "solicitation_fee_brand" (
	"id" bigint PRIMARY KEY GENERATED ALWAYS AS IDENTITY (sequence name "solicitation_fee_brand_id_seq" INCREMENT BY 1 MINVALUE 1 MAXVALUE 9223372036854776000 START WITH 1 CACHE 1),
	"slug" varchar(50),
	"brand" varchar(100),
...
--> statement-breakpoint
CREATE TABLE "solicitation_fee_document" (
	"id" bigint PRIMARY KEY GENERATED ALWAYS AS IDENTITY (sequence name "solicitation_fee_document_id_seq" INCREMENT BY 1 MINVALUE 1 MAXVALUE 9223372036854776000 START WITH 1 CACHE 1),
	"slug" varchar(50),
	"id_file" bigint,
	"type" varchar(20),
	"dtinsert" timestamp DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE "sync_log" (
	"id" bigint PRIMARY KEY GENERATED ALWAYS AS IDENTITY (sequence name "sync_log_id_seq" INCREMENT BY 1 MINVALUE 1 MAXVALUE 9223372036854776000 START WITH 1 CACHE 1),
...
CREATE TABLE "user_merchants" (
	"id" bigint PRIMARY KEY GENERATED ALWAYS AS IDENTITY (sequence name "user_merchants_id_seq" INCREMENT BY 1 MINVALUE 1 MAXVALUE 9223372036854776000 START WITH 1 CACHE 1),
	"dtinsert" timestamp DEFAULT CURRENT_TIMESTAMP,
	"dtupdate" timestamp DEFAULT CURRENT_TIMESTAMP,
	"active" boolean DEFAULT true,
	"id_merchant" bigint,
...
CREATE TABLE "user_notifications" (
	"id" bigint PRIMARY KEY GENERATED ALWAYS AS IDENTITY (sequence name "user_notifications_id_seq" INCREMENT BY 1 MINVALUE 1 MAXVALUE 9223372036854776000 START WITH 1 CACHE 1),
	"slug" varchar(50),
	"dtinsert" timestamp DEFAULT CURRENT_TIMESTAMP,
	"dtupdate" timestamp DEFAULT CURRENT_TIMESTAMP,
	"active" boolean,
...
--> statement-breakpoint
CREATE TABLE "users" (
	"id" bigint PRIMARY KEY GENERATED ALWAYS AS IDENTITY (sequence name "users_id_seq" INCREMENT BY 1 MINVALUE 1 MAXVALUE 9223372036854776000 START WITH 1 CACHE 1),
	"slug" varchar(50),
	"dtinsert" timestamp DEFAULT CURRENT_TIMESTAMP,
	"dtupdate" timestamp,
	"active" boolean DEFAULT true,
...
--> statement-breakpoint
ALTER TABLE "categories" ADD CONSTRAINT "cnae_solicitation_fee_id" FOREIGN KEY ("id_solicitation_fee") REFERENCES "public"."solicitation_fee"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "fee_brand" ADD CONSTRAINT "fee_brand_id_fee_fkey" FOREIGN KEY ("id_fee") REFERENCES "public"."fee"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "fee_brand_product_type" ADD CONSTRAINT "fee_brand_product_type_id_fee_brand_fkey" FOREIGN KEY ("id_fee_brand") REFERENCES "public"."fee_brand"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "fee_credit" ADD CONSTRAINT "fee_credit_id_fee_brand_product_type_fkey" FOREIGN KEY ("id_fee_brand_product_type") REFERENCES "public"."fee_brand_product_type"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "financial_adjustment_merchants" ADD CONSTRAINT "financial_adjustment_merchants_id_financial_adjustment_fkey" FOREIGN KEY ("id_financial_adjustment") REFERENCES "public"."financial_adjustments"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "financial_adjustment_merchants" ADD CONSTRAINT "financial_adjustment_merchants_id_merchant_fkey" FOREIGN KEY ("id_merchant") REFERENCES "public"."merchants"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "fornecedor_documents" ADD CONSTRAINT "fk_document_fornecedor" FOREIGN KEY ("fornecedor_id") REFERENCES "public"."fornecedores"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "fornecedores" ADD CONSTRAINT "fk_fornecedor_cnae" FOREIGN KEY ("cnae_codigo") REFERENCES "public"."cnaes"("codigo") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "merchant_settlement_orders" ADD CONSTRAINT "merchant_settlement_orders_id_merchant_settlements_fkey" FOREIGN KEY ("id_merchant_settlements") REFERENCES "public"."merchant_settlements"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "merchants" ADD CONSTRAINT "merchants_id_merchant_bank_account_fkey" FOREIGN KEY ("id_merchant_bank_account") REFERENCES "public"."merchant_bank_accounts"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "solicitation_brand_product_type" ADD CONSTRAINT "solicitation_brand_product_type_solicitation_fee_brand_id_fkey" FOREIGN KEY ("solicitation_fee_brand_id") REFERENCES "public"."solicitation_fee_brand"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "solicitation_fee" ADD CONSTRAINT "solicitation_fee_id_customers_fkey" FOREIGN KEY ("id_customers") REFERENCES "public"."customers"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "solicitation_fee_brand" ADD CONSTRAINT "solicitation_fee_brand_solicitation_fee_id_fkey" FOREIGN KEY ("solicitation_fee_id") REFERENCES "public"."solicitation_fee"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "solicitation_fee_document" ADD CONSTRAINT "solicitation_fee_document_id_file_fkey" FOREIGN KEY ("id_file") REFERENCES "public"."file"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "solicitation_fee_document" ADD CONSTRAINT "solicitation_fee_document_solicitation_fee_id_fkey" FOREIGN KEY ("solicitation_fee_id") REFERENCES "public"."solicitation_fee"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "user_notifications" ADD CONSTRAINT "user_notifications_id_user_fkey" FOREIGN KEY ("id_user") REFERENCES "public"."users"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
