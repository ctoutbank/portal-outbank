import { pgTable, foreignKey, varchar, bigint, boolean, timestamp, integer, numeric, unique, serial, char, date, text, index, uuid, time, jsonb } from "drizzle-orm/pg-core"
...
export const fornecedores = pgTable("fornecedores", {
	...
	index("idx_fornecedores_ativo").using("btree", table.ativo.asc().nullsLast().op("bool_ops")),
	index("idx_fornecedores_cnpj").using("btree", table.cnpj.asc().nullsLast().op("text_ops")),
	index("idx_fornecedores_nome").using("btree", table.nome.asc().nullsLast().op("text_ops")),
