...
export function FornecedorCard({ fornecedor, onEdit, onDelete, canEdit, canDelete, categories }: FornecedorCardProps) {
    ...
    return (
        <div 
            ...
            className="bg-white dark:bg-[#171717] border border-gray-200 dark:border-gray-700 rounded-lg shadow-md p-5 hover:shadow-lg transition-shadow min-w-0 cursor-pointer"
        >
            ...
            {/* ✅ MODAL DE EDIÇÃO COM STOPPROPAGATION */}
            {showEditModal && (
                <div 
            ...
            {/* ✅ MODAL DE VISUALIZAÇÃO COM STOPPROPAGATION */}
            {showViewModal && (
                <div 
                    onClick={(e) => e.stopPropagation()}
                    className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4"
