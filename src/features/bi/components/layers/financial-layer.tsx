...
import { CHART_PALETTE, formatCurrencyFull, formatCurrencyShort } from "../shared/colors";
import {
  BarChart,
  Bar,
  XAxis,
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        <InfoCard
          title="Valor Bruto"
          value={formatCurrencyFull(settlement.bruto)}
          icon={Wallet}
        />
        <InfoCard
          title="Valor Líquido"
          value={formatCurrencyFull(settlement.liquido)}
          icon={ArrowUpRight}
          iconColor="green"
        />
        <InfoCard
          title="Receita de Taxas"
          value={formatCurrencyFull(settlement.taxas)}
          icon={ArrowDownRight}
        />
        <InfoCard
